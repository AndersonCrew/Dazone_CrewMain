...
public class BoditechCoffeeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(projectCode.equals(Constants.PROJECT_CODE_COFFEE) ? R.string.boditech :
                projectCode.equals(Constants.PROJECT_CODE_PMS) ? R.string.pms : R.string.hanmaru);
        ...
        final String password = CrewCloudApplication.getInstance().getPreferenceUtilities().getCurrentPassword();
        ...
        if(projectCode.equals(Constants.PROJECT_CODE_COFFEE)) {
        ...
        } else if(projectCode.equals(Constants.PROJECT_CODE_PMS)){
            ...
            String url = "https://hanmaru.ehansco.co.kr/Login?" + postData;
