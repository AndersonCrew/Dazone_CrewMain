...
public class PreferenceUtilities {
    ...
    private final String KEY_CURRENT_PASSWORD = "currentPassword";
    ...
    public String getCurrentPassword() {
        return mPreferences.getString(KEY_CURRENT_PASSWORD, "crewadmin!");
    }

    public void setCurrentPassword(String password) {
        mPreferences.edit().putString(KEY_CURRENT_PASSWORD, password).apply();
    }
