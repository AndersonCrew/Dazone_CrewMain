...
public class ApplicationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.iv_inflate_layout_app_item_icon)
        ImageView iv_inflate_layout_app_item_icon;

        @BindView(R.id.tv_inflate_layout_app_item_name)
        TextView tv_inflate_layout_app_item_name;

        @BindView(R.id.badge_notification_3)
        TextView tvBadge;
        ...
        void bind(int position) {
            ...
            switch (application.ProjectCode) {
                ...
                case Constants.PROJECT_CODE_HANMARU: {
                    iv_inflate_layout_app_item_icon.setImageResource(R.drawable.pms);
                    tv_inflate_layout_app_item_name.setText(R.string.hanmaru);
                    break;
                }
